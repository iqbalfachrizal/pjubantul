        ...
        <div class="w-full">
            <main class="relative isolate h-150 flex items-center justify-center bg-gray-900">
                ...
                <div class="mx-auto max-w-full px-6 py-20 text-center">
                    ...
                    <p class="mt-6 text-xl leading-8 text-white max-w-2xl mx-auto">
                    ...
                    <div class="mt-10 flex justify-center gap-x-6">
                        <a href="#"
                            class="rounded-md bg-blue-600 px-6 py-3 text-white font-semibold shadow-sm hover:bg-blue-500">
                            Lihat Peta PJU
                        </a>
                    </div>
